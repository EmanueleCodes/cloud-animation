...
import { AnimatedCloud, DEFAULT_CLOUD_PARAMS } from '#/components/cloud'
import type { CloudParams } from '#/components/cloud'
...
function Home() {
    const dial = useDialKit('Cloud', {
        ...
        radiusOscillation: {
            amplitude: [
                DEFAULT_CLOUD_PARAMS.radiusOscillation.amplitude,
                0,
                80,
            ],
